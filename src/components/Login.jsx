...
import phone from "../assets/png-transparent-mobile-phone-illustration-computer-icons-smartphone-iphone-handphone-angle-gadget-electronics.png";
import google from "../assets/Google_Icons-09-512.webp"
...
function Login(props) {
    ...
    const googleSignup = async() =>{
        try{
            const loged = await signInWithPopup(auth,googleProvider)
            
            if(loged){
                setUser(loged.user.uid)
         ...
         <div className="sm:flex sm:items-start">
           <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
             <div className="mt-2">
               ...
               <div onClick={googleSignup}  className="flex border border-gray-300 p-2 rounded-md mt-4 cursor-pointer">
